...
def buy():
    ...
    for p in lister:
        itemlist = itemlist + '<div class="item-listing"><form method="post" action="/cart" enctype="multipart/form-data"><img src="../static/image/popular-02.jpg" alt="Insert Alt Text" style="width:100%;height:300px"> <p class="name">' + str(
